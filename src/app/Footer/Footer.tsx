...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-100 py-8 px-4 text-gray-700">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          {(activeSection === "getInTouch" || !isMobileOrTablet) && (
            <>
              <p className="flex items-center gap-2 mb-2">
                <FaMapMarkerAlt /> 184 Main Rd E, St Albans VIC 3021, Australia
              </p>
              <p className="flex items-center gap-2 mb-2">
                <FaEnvelope /> contact@company.com
              </p>
              <p className="flex items-center gap-2">
                <FaPhone /> +001 2233 456
              </p>
        ...
        <div>
          ...
          {(activeSection === "categories" || !isMobileOrTablet) && (
            <ul className="space-y-2">
              ...
              <li><Link href="/decor">Decor</Link></li>
              <li><Link href="/denim">Denim</Link></li>
              <li><Link href="/dress">Dress</Link></li>
              <li><Link href="/hats">Hats</Link></li>
              <li><Link href="/newarrival">New Arrival</Link></li>
            </ul>
          )}
        </div>
        ...
        <div>
          ...
          {(activeSection === "newsletter" || !isMobileOrTablet) && (
            <>
              <p className="text-sm mb-2">Subscribe to our newsletter and get 10% off your first purchase</p>
      ...
      {/* Footer Bottom */}
      <div className="text-center mt-6 text-gray-500 text-sm">© 2025 Kalles. All rights reserved.</div>
    </footer>
  );
};
