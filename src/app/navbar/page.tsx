...
import ProductDropdown from "./ProductDropdown"; // ✅ New Import
    ...
    <header className="w-full border-b shadow-sm">
      ...
      <nav className="flex justify-between items-center px-6 md:px-8 py-4">
        ...
        <ul className="hidden lg:flex space-x-6 text-lg font-medium">
          <li className="cursor-pointer hover:text-blue-500 transition"> <Link href="/">Home</Link> </li>
          <li>
            <ShopDropdown />
          </li>

          {/* ✅ Use the new Product Dropdown */}
          <ProductDropdown />
